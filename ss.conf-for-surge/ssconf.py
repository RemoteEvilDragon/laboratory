...
def genGfwConf(config_file,output_file):
    ...
    proxy = codecs.open(config_file, 'r', 'utf8')
    file_content = f.read()
    ...
    confs = codecs.open('configFileHere/'+output_file, 'w','utf-8')
...
def main():
    ...
    genGfwConf("ServerConfig__.txt","gfwlist2.conf")
    genGfwConf("ServerConfig.txt","gfwlist.conf")
    genGfwConf("ServerConfig1.txt","gfwlist1.conf")
