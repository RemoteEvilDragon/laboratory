...
class SimpleHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def deal_post_data(self):
        ...
        # print "remainbytes now is "+str(remainbytes)
        ...
        # print "current line1 is "+line

        # print "line1 over"
        # line = self.rfile.readline()
        # remainbytes -= len(line)

        # print "current line1 is "
        ...
        print "prelineNum now is "+str(len(preline))
    ...
    def unzipFile(self):
        fh = open(self.upload_FileName,'rb')
